...
class SeenHandler(BaseHandler):
    ...
    def post(self):    
        ...
        the_member_key = member.member_from_urlsafe(urlsafe=the_member_keystr, key_only=True)
        if the_member_key:
...
class SeenWelcomeHandler(BaseHandler):
    ...
    def post(self):    
        ...
        the_member_key = member.member_from_urlsafe(the_member_keystr, key_only=True)
        if the_member_key:
