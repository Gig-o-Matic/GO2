...
if False:  # maintenance mode?
    ...
    APPLICATION = webapp2.WSGIApplication([
        ...
        webapp2.Route('/reset_counts', band_handlers.ResetCounts),
        ...
        webapp2.Route('/email_sg_admin', email_sg_util.AdminPage, name='email_sg_admin'),
        ...
        webapp2.Route('/member_calfeed_generate', caldav.MemberCalfeedGenerateHandler),
